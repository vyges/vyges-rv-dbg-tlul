...
#(
    ...
    // ── Internal signals ─────────────────────────────────────────────
    // Pulp dm_top slave port
    logic                   dm_slave_req;
    logic                   dm_slave_we;
    logic [BusWidth-1:0]    dm_slave_addr;
    logic [BusWidth/8-1:0]  dm_slave_be;
    logic [BusWidth-1:0]    dm_slave_wdata;
    logic [BusWidth-1:0]    dm_slave_rdata;
